package hello.core.propagation;
...
public class BasicTxTest {
    ...
    void inner_rollback() {
        ...
        TransactionStatus inner = txManager.getTransaction(new DefaultTransactionAttribute());
        log.info("내부 트랜잭션 롤백");
        txManager.rollback(inner); // 참여중인 트랜잭션에 rollback-only 마킹
    ...
    void inner_rollback_requires_new() {
        ...
        definition.setPropagationBehavior(TransactionDefinition.PROPAGATION_REQUIRES_NEW); // 기존 트랜잭션 무시, 신규 트랜잭션 시작
