package hello.core.config.v2_dynamicproxy;

import hello.core.app.v1.*;
import hello.core.config.v2_dynamicproxy.handler.LogTraceBasicHandler;
import hello.core.config.v2_dynamicproxy.handler.LogTraceFilterHandler;
